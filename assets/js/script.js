...
// Dirubah 
const pengirim = "Rico";
const nomorWa = "6282135448774" // awalan nomor 0 harus di awalin 62
const textWa = "Keep strong ya semangat terus"
const pesan = `tetap semangat ya jalani hidup sehari-harimu jan sampe patah semangat ada orang yang selalu bersamamu.`;

if (pengirim) {
  nama.innerHTML = pengirim;
  nama1.innerHTML = pengirim;
} else {
  nama.innerHTML = "Afriansyah";
  nama1.innerHTML = "Afriansyah";
}
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    imageHeight: 120,
    title: 'Sayang, coba masukin nama kamu dong',
    ...
    preConfirm: () => {
      ...
      if (!login) {
        Swal.showValidationMessage(` Sayang coba masukin nama kamu dong :(`)
      }
      return { login }
    }
  }).then((result) => {
